...
urlpatterns = [
    ...
    path('admin_password_reset/<int:admin_id>/', all_views.AdministratorPasswordReset.as_view(),
         name='admin-password-reset'),
    path('admin_edit/<int:admin_id>/', all_views.AdministratorEditView.as_view(), name='admin-edit'),
